...
public class LoginActivity extends AppCompatActivity {
    ...
    AppCompatButton mAppCombatButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCombatButton=(AppCompatButton)findViewById(R.id.not_a_member_signup_button);
        mAppCombatButton.setOnClickListener(new View.OnClickListener() {
            @Override
