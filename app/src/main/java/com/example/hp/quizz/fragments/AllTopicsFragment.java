package com.example.hp.quizz.fragments;
...
import com.example.hp.quizz.adapter.TopicAdapter;
...
public class AllTopicsFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        final TopicAdapter topicsAdapter=new TopicAdapter(getContext(),mArrayList);
        ...
        mFirebaseDatabase.getReference("quizz").child("topics").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
               // String key=dataSnapshot.getKey();
                ...
                String toicName=dataSnapshot.getValue(String.class);
                topicsAdapter.addTopic(toicName);
